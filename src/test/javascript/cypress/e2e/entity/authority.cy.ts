...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: 'a283059a-6688-4247-a4ac-c5e13f0114d1' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('ab17c155-441a-4ef6-8036-1dedc87558e8');
      cy.get(`[data-cy="name"]`).should('have.value', 'ab17c155-441a-4ef6-8036-1dedc87558e8');
